...
app = Flask(__name__, template_folder='/home/sanojmv/bytedev/week5/flask_prj/webpages')
...
def view_portfolio():
	if(request.method == 'GET'):
		...
		cs = round(re[1],2)
		return render_template("view_portfolio.html", re=re, result=result,res=res, cs=cs, lengres = len(res), lengresult = len(result),)
